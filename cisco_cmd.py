...
parser.add_argument("-c", "--cmd", action='store_false', help='Run a built-in command from array')
parser.add_argument("-b", "--list-builtin", action='store_false', help='List the available built-in commands from an array')
parser.add_argument("-o", "--option", action='store_false', help='Optional user input filter for the builtin commands')
parser.add_argument("-d", "--custom", action='store_false', help='Custom command generated by user')                    
parser.add_argument("-m", "--module", action='store_false', help='Run selected module from the available modules')
