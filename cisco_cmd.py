...
parser.add_argument("-c", "--cmd", dest='quiet', help='Run a built-in command from array')
parser.add_argument("-o", "--option", dest='quiet', help='Optional user input filter for the builtin commands')
parser.add_argument("-d", "--custom", dest='quiet', help='Custom command generated by user')                    
parser.add_argument("-m", "--module", dest='quiet', help='Run selected module from the available modules')
